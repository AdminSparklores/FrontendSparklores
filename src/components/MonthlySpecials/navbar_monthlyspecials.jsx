...
import banner from "../../assets/default/navbar_necklace_bg.png";
...
const NavBar_MonthlySpecials = () => {
  ...
  useEffect(() => {
    ...
    const getBannerImage = async () => {
      try {
        const imageUrl = await fetchPageBanner("monthly_special");
        ...
        <div className="relative flex flex-col md:items-center md:justify-center md:text-center text-white">
          ...
          <div className="relative flex flex-col items-center justify-center text-center px-4 mt-10 md:mt-42 text-white">
            <h1 className="text-xl md:text-4xl mb-4 tracking-wider">
              Wear Your Story, Close to Your Heart With Our Monthly Specials
            </h1>
            <p className="text-md md:text-3xl max-w-4xl leading-relaxed">
              From delicate chains to bold statement pieces, find a necklace that reflects your unique style and personality.
            </p>
          </div>
        </div>
      </div>
...
export default NavBar_MonthlySpecials;