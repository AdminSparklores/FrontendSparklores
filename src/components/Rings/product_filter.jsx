  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter only ring products and transform data
        let ringProducts = data
          .filter(product => product.category && product.category.toLowerCase() === "ring")
          .map(product => ({
            ...product,
            id: product.id,
            name: product.name,
