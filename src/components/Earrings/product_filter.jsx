  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Filter only earring products and transform data
        let earringProducts = data
          .filter(product => product.category && product.category.toLowerCase() === "earring")
          .map(product => ({
            ...product,
            id: product.id,
            name: product.name,
